...
| Profile-list overlap and dependency closure | 16.18.4 | Evidence gap | Dependency and extension-namespace enforcement is asserted; overlap, missing closure, and duplicate scoped identities are not separately asserted. |
