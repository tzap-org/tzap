...
|---|---|
| **Format version** | 1 |
| **Document version** | 0.35 / 2026-05-22.5 (FileEntry frame-range and directory-prefix lookup fixes) |
| **Status** | Draft for review, no implementation yet |
| **Owner** | Frank Zhu |
| **Maintainers** | Frank Zhu |
| **Last updated** | 2026-05-22 |
| **Supersedes** | v0.1, v0.2, v0.3, v0.4, v0.5, v0.6, v0.7, v0.8, v0.9, v0.10, v0.11, v0.12, v0.13, v0.14, v0.15, v0.16, v0.17, v0.18, v0.19, v0.20, v0.21, v0.22, v0.23, v0.24, v0.25, v0.26, v0.27, v0.28, v0.29, v0.30, v0.31, v0.32, v0.33, v0.34 |
| **Superseded by** | None |
| **Conflict rule** | This document supersedes earlier tzap format drafts. If it conflicts with v0.1-v0.34 text, this v0.36 draft wins unless a later dated spec explicitly supersedes it. |
| **File extension** | `.tzap` (single-volume) / `.tzap.NNN` (multi-volume) |

## Changelog from v0.34

This revision resolves random-access correctness and directory extraction
findings in v0.34: non-minimal FileEntry frame ranges could force readers
...
struct VolumeHeader {
    ...
    volume_format_rev:        u16,       // 35 for this draft
...
1. Read VolumeHeader at offset 0; verify CRC.
   ...
   `volume_format_rev != 35`. Reject if `VolumeHeader.stripe_width = 0`
...
Additional v0.34 cases retained from the previous draft:
...
- **Volume format revision freshness**: create archives with
  `volume_format_rev` below, equal to, and above 35; verify v0.36-only
  readers accept only 35 and reject older or newer revisions.
...
- **Volume format revision**: create archives with `volume_format_rev`
  below, equal to, and above 35; verify v0.36-only readers accept only 35
...
## Appendix A: All changes from v0.34 -> v0.36

| Section | Change |
|---|---|
| §8 / §17.1 / §23 / §28.1 / §29 | `volume_format_rev` is bumped to 35 |
